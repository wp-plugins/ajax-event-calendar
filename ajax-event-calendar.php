...
define('AEC_PLUGIN_VERSION', '0.9.8.51');
...
define('AEC_DEBUG', false);	// do not modify this setting the plugin is functioning

// overrides the location of the WP error log to the AEC plugin root
